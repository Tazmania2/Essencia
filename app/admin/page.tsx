      ...
      <div className="bg-white rounded-2xl shadow-xl p-6 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Link href="/admin/configuration">
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl p-6 hover:shadow-lg transition-all cursor-pointer group">
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Configurar dashboards e métricas</p>
                </div>
              </div>
            </div>
          </Link>
