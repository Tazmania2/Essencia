        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium transition-colors ${currentConfiguration
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center space-x-3">
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium transition-colors ${validatingImport
                ? 'bg-gray-300 text-gray-500 cursor-not-allowed'
