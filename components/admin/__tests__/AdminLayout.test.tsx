...
describe('AdminLayout', () => {
  ...
  it('renders children content', () => {
    render(<AdminLayout {...defaultProps} />, { user: testUser });
  ...
  it('renders with custom current section', () => {
    render(<AdminLayout {...defaultProps} currentSection="players" />, { user: testUser });
  ...
  it('renders breadcrumb when items are provided', () => {
    ...
    render(<AdminLayout {...defaultProps} breadcrumbItems={breadcrumbItems} />, { user: testUser });
